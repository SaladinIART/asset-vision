...
Reuses detector.py and qrtools.py from Phase A via sys.path injection.
...
from qrtools import decode_qr, annotate_qr, associate_qr_to_detections  # noqa: E402

from asset_interfaces.msg import DetectedAsset, AssetDetections  # noqa: E402
...
class PerceptionNode(Node):
    ...
    def _on_image(self, msg: Image):
        ...
        # QR decode + associate to nearest detection box
        qrs = decode_qr(frame)
        ...
        for qr in qrs:
            ...
            if idx is not None:
                ...
                detections[idx].qr_payload = qr.payload

        inference_ms = (time.perf_counter() - t0) * 1000

        # Build AssetDetections message
